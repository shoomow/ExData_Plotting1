...
legend("topright", "(x,y)", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty =1, cex = 0.75)
dev.copy(png, "plot3.png", bg = "white", width = 480, height = 480, units = "px")
dev.off()